# AGENTS.md — internal/pkg/manifest
...
- `internal/pkg/manifest/detect.go` (go, 10 symbols)

## 关键符号

- `DetectKind` (exported) — `internal/pkg/manifest/detect.go:17`
- `fileExists` — `internal/pkg/manifest/detect.go:30`
